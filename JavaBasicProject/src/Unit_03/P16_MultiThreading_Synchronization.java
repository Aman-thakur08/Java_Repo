...
//where and when to use synchronize keywords?
// 	-when there is a shared resource , we use synchronized keyword because of context switching 
//   updates the same thing twice
//where and when to use join method ?
// -when we want main method to wait for another thread so we go down to execute other
